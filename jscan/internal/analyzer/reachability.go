...
// ReachabilityResult preserves jscan's enriched projection of core reachability.
...
// AnalyzeReachabilityFrom is retained for compatibility with internal tooling.
// Core owns entry-based analysis; this projection performs structural DFS from
// an explicitly supplied block.
...
// reachabilityVisitor remains as a lightweight traversal adapter used by
// benchmarks and compatibility tests; traversal itself is owned by core CFG.
